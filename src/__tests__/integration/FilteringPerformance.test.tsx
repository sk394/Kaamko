  ...
  describe('Filter Accuracy Tests', () => {
    it('should correctly filter sessions by date ranges', async () => {
      ...
      const mockSessions: SessionObject[] = [
        ...
        },
        {
          ...
          clockOut: new Date(
            oldSession.getTime() + 8 * 60 * 60 * 1000
          ).toISOString(),
          hours: 8,
        },
      ];
    ...
    it('should handle edge cases in date filtering', async () => {
      ...
      const mockSessions: SessionObject[] = [
        {
          ...
          clockOut: new Date(
            exactlyOneWeekAgo.getTime() + 8 * 60 * 60 * 1000
          ).toISOString(),
          hours: 8,
        },
        {
          ...
          clockOut: new Date(
            exactlyOneMonthAgo.getTime() + 8 * 60 * 60 * 1000
          ).toISOString(),
          hours: 8,
        },
      ];
      ...
      await waitFor(() => {
        ...
        expect(
          getByText(/Showing \d+ of 2 sessions \(Last Week\)/)
        ).toBeTruthy();
      });
      ...
      await waitFor(() => {
        ...
        expect(
          getByText(/Showing \d+ of 2 sessions \(Last Month\)/)
        ).toBeTruthy();
      });
    });
  });
